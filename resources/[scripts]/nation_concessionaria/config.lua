...
-- Compatibilidade com bases Creative/vRP modernas.
vRP._prepare = vRP._prepare or vRP.Prepare
vRP.prepare = vRP.prepare or vRP.Prepare
vRP.query = vRP.query or vRP.Query
vRP.execute = vRP.execute or vRP.Execute
...
LEIA O .TXT DEIXADO NO RAR PARA SOLUCIONAR DÃšVIDAS
LEIA O .TXT DEIXADO NO RAR PARA SOLUCIONAR DÃšVIDAS
COLE A PASTA vrp_images deixada no .RAR que vocÃª baixou no seguinte local: C:\xampp\htdocs
COLE A PASTA vrp_images deixada no .RAR que vocÃª baixou no seguinte local: C:\xampp\htdocs
COLE A PASTA vrp_images deixada no .RAR que vocÃª baixou no seguinte local: C:\xampp\htdocs
COLE A PASTA vrp_images deixada no .RAR que vocÃª baixou no seguinte local: C:\xampp\htdocs
...
config.imgDir = "nui://nation_concessionaria/vrp_images/" -- imagens sincronizadas do XAMPP para dentro do resource

-- LISTA DOS VEÃCULOS EM DESTAQUE

config.topVehicles = {	 
	"panto"
}

config.logo = "nui://nation_concessionaria/vrp_images/panto.png" -- logo local

config.defaultImg = "nui://nation_concessionaria/vrp_images/blank.gif" -- imagem default local

config.openconce_permission = nil -- permissao para abrir a concessionaria

config.updateconce_permission = "Admin" -- /conce tambem aceita Passport 1 no server.lua adaptado

config.porcentagem_venda = 50 -- porcentagem de venda dos veÃ­culos possuidos

config.porcentagem_testdrive = 0.1 -- porcentagem do valor do veÃ­culo paga para a realizaÃ§Ã£o do test drive

config.tempo_testdrive = 30 -- tempo de duraÃ§Ã£o do test drive em segundos

config.maxDistance = 300 -- distÃ¢ncia mÃ¡xima (em radius(raio)) que o player poderÃ¡ ir quando estiver realizando o test drive

config.porcentagem_aluguel = 1 -- porcentagem do valor do veÃ­culo paga para alugar

-- Fallback usado para veiculos que existem no Nation.sql, mas ainda nao foram cadastrados no Vehicle.lua do vRP.
-- Voce pode sobrescrever por veiculo direto no HeidiSQL usando as colunas price/name/class/weight da tabela nation_concessionaria.
config.defaultVehiclePrice = 100000
config.defaultVehicleWeight = 40
...
-- IMAGEM QUE APARECE NA SEÃ‡ÃƒO DE 'MEUS VEÃCULOS'

config.myVehicles_img = "https://www.itl.cat/pngfile/big/50-505834_download-nfs-hot-pursuit.jpg"

-- CLASSES DOS VEÃCULOS INSERIDAS DENTRO DAS CLASSES QUE APARECEM NA CONCE

config.availableClasses = {
	["compactos"] = {"compact", "Compactos"},
	["sedans"] = {"sedan", "Sedans"},
	["suvs"] = {"suv", "off-road", "SUVs", "Off-Road"},
	["imports"] = {"coupe", "muscle", "classic", "sport", "super", "Premium", "Vip", "Standard", "Esportivos", "Classicos", "ClÃ¡ssicos", "Importados"},  
	["trucks"] = {"industrial", "utility", "commercial"},
	["motos"] = {"moto", "cycle"},
	["outros"] = {"boat", "helicopter", "plane", "service", "emergency", "military", "train", "van", "none", "Desconhecido", "outros"}
}

-- ÃCONES DA CONCE

local legacyMiscIcons = {
	{ description = "ForÃ§a e velocidade necessÃ¡rias para aquela dose de adrenalina.", img = "https://www.flaticon.com/svg/static/icons/svg/586/586141.svg" },
	{ description = "IncrÃ­veis opÃ§Ãµes econÃ´micas que cabem no seu bolso!", img = "https://www.flaticon.com/svg/static/icons/svg/846/846117.svg" },
	{ description = "Para vocÃª que valoriza a eficÃ¡cia e praticidade.", img = "https://www.flaticon.com/svg/static/icons/svg/1535/1535519.svg" },
}

config.miscIcons = {
	{ description = "Forca e velocidade para aquela dose de adrenalina.", img = "nui://nation_concessionaria/vrp_images/zentorno.png" },
	{ description = "Opcoes economicas que cabem no seu bolso.", img = "nui://nation_concessionaria/vrp_images/panto.png" },
	{ description = "Eficiencia e praticidade para o dia a dia.", img = "nui://nation_concessionaria/vrp_images/dubsta.png" },
}
...
-- cada veÃ­culo deve conter => { hash, name, price, banido, modelo, capacidade, tipo }
...
config.vehList = {
	...
	{ hash = -667151410, name = 'ratloader', price = 1000, banido = false, modelo = 'CaminhÃ£o', capacidade = 80, tipo = 'work' },
	...
	{ hash = -875050963, name = 'policiaheli', price = 1000, banido = true, modelo = 'Policia HelicÃ³ptero', capacidade = 0, tipo = 'work' },
	...
	{ hash = -792745162, name = 'paramedicoambu', price = 1000, banido = true, modelo = 'AmbulÃ¢ncia', capacidade = 0, tipo = 'work' },
	{ hash = 108063727, name = 'paramedicocharger2014', price = 1000, banido = true, modelo = 'Dodge Charger 2014', capacidade = 0, tipo = 'work' },
	{ hash = 2020690903, name = 'paramedicoheli', price = 1000, banido = true, modelo = 'ParamÃ©dico HelicÃ³ptero', capacidade = 0, tipo = 'work' },
	...
	{ hash = -713569950, name = 'bus', price = 1000, banido = true, modelo = 'Ã”nibus', capacidade = 0, tipo = 'work' },
	...
	{ hash = -667151410, name = 'ratloader', price = 1000, banido = true, modelo = 'CaminhÃ£o', capacidade = 80, tipo = 'work' },
	{ hash = -589178377, name = 'ratloader2', price = 1000, banido = false, modelo = 'Ratloader2', capacidade = 70, tipo = 'work' },
	{ hash = -1705304628, name = 'rubble', price = 1000, banido = true, modelo = 'CaminhÃ£o', capacidade = 0, tipo = 'work' },
	{ hash = -956048545, name = 'taxi', price = 1000, banido = true, modelo = 'Taxi', capacidade = 0, tipo = 'work' },
	{ hash = 444171386, name = 'boxville4', price = 1000, banido = false, modelo = 'CaminhÃ£o', capacidade = 70, tipo = 'work' },
	{ hash = -1255698084, name = 'trash2', price = 1000, banido = false, modelo = 'CaminhÃ£o', capacidade = 80, tipo = 'work' },
	...
	{ hash = -726768679, name = 'seasparrow', price = 1000, banido = true, modelo = 'ParamÃ©dico HelicÃ³ptero Ãgua', capacidade = 0, tipo = 'work' },
	...
	{ hash = -133349447, name = 'evo9', price = 1400000, banido = false, modelo = 'Lancer Evolution 9', capacidade = 50, tipo = 'import' },
	...
	{ hash = 1995020435, name = 'celta', price = 1000000, banido = false, modelo = 'Celta ParedÃ£o', capacidade = 0, tipo = 'exclusive' },
...
-- RETORNA A LISTA DE VEÃCULOS
config.getVehList = function()
	return config.vehList
end

-- RETORNA AS INFORMAÃ‡Ã•ES CONTIDAS NA LISTA DE UM VEÃCULO ESPECÃFICO
...
-- RETORNA O MODELO DE UM VEÃCULO ESPECÃFICO (NOME BONITINHO)
...
-- RETORNA A CAPACIDADE DO PORTA-MALAS DE UM VEÃCULO ESPECÃFICO
...
-- RETORNA O PREÃ‡O DE UM VEÃCULO ESPECÃFICO
...
-- RETORNA O TIPO DE UM VEÃCULO ESPECÃFICO
...
-- RETORNA O STATUS DE BANIDO DE UM VEÃCULO ESPECÃFICO
...
-- RETORNA AS INFORMAÃ‡Ã•ES DO VEÃCULO REFERENTE Ã€ LISTA DE VEÃCULOS (VEHLIST)
config.getVehicleInfo = function(vehicle)
	for i in ipairs(config.vehList) do
		if vehicle == config.vehList[i].hash or vehicle == config.vehList[i].name then
            return config.vehList[i]
...
-- NOMES DAS CLASSES DOS VEÃCULOS
...
config.tryBuyVehicle = function(source, user_id, vehicle, color, price, mods)
	if source and user_id and vehicle and color and price and mods then
		...
		if hasVehicle and not isRented then
			return false, "veÃ­culo jÃ¡ possuÃ­do"
		end
...
config.trySellVehicle = function(source, user_id, vehicle, price)
	if source and user_id and vehicle and price then
		...
		if hasVehicle then
			...
			return false, "veÃ­culo alugado ou jÃ¡ vendido"
		end
	end
	return false, "erro inesperado"
end
...
-- VERIFICAÃ‡ÃƒO DO PAGAMENTO DO TEST DRIVE
...
-- DEVOLVER O DINHEIRO CASO NÃƒO DÃŠ PARA FAZER O TEST

config.chargeBack = function(source,user_id, price)
	if source and user_id and price then
		vRP.giveMoney(user_id,price)
		TriggerClientEvent("Notify",source,"aviso", "VocÃª recebeu seus <b>$ "..vRP.format(price).."</b> de volta.", 3000)
	end
end



-- VERIFICAÃ‡ÃƒO DE ALUGUEL DO VEÃCULO
...
-- VERIFICAÃ‡ÃƒO DO PAGAMENTO DO ALUGUEL DO VEÃCULO
...
-- getTopList() -- desativado: o server.lua adaptado monta a lista apos criar a tabela


-- LOCAIS DAS CONCESSIONARIAS E REALIZAÃ‡ÃƒO DE TESTES

config.locais = {
	{ 
		conce = vec3(-54.30,-1094.80,26.42), 
		test_locais = {
