...
Config.Exam = {
    ...
    Route = {
        ...
        Checkpoints = {
            ...
            { Coords = vec3(-1700.05,98.51,64.43), Radius = 6.0, Label = "Ponto 8" },
            { Coords = vec3(-1750.4303,249.5412,65.4708), Radius = 6.0, Label = "Ponto 9" },
            { Coords = vec3(-1827.5443,147.0405,77.0835), Radius = 6.0, Label = "Ponto 10", StopRequired = true },
            { Coords = vec3(-1848.5021,86.1217,78.0002), Radius = 6.0, Label = "Ponto 11" },
            { Coords = vec3(-2138.8445,401.0434,135.4923), Radius = 6.0, Label = "Ponto 12" },
            { Coords = vec3(-2310.8662,416.3783,173.9017), Radius = 6.0, Label = "Ponto 13" },
        ...
        CorridorAnchors = {
            ...
            { Coords = vec3(-1700.05,98.51,64.43) },
