...
List = {
	...
	SaoJudasLaboratory = {
		...
		ProductionEnabled = SaoJudasOperations.Laboratory.ProductionEnabled,
		List = SaoJudasOperations.Laboratory.Recipes
	},
	SaoJudas = {
		Permission = "SaoJudas",
		Transactional = true,
		Title = "Bancada de Sao Judas",
		Category = "Ferramentas ilegais",
		List = SaoJudasOperations.Workbench.Recipes
	},
	Lester = {
		Permission = "Lester",
		List = {
...
if not SaoJudasOperations.Workbench.ExclusiveRecipes then
	for Item,Recipe in pairs(SaoJudasOperations.Workbench.Recipes) do
		if Item == "lockpick" or Item == "blocksignal" or Item == "dismantle" then
			List.Lester.List[Item] = Recipe
		end
	end
end
